...
class Blood extends State {
   ...
   getLocation() {
    ...
    static createInstance(DIN, mm, type, date, expired, test, donorID, temperature) {
        return new Blood({ DIN, mm, type, date, expired, test, donorID, temperature, currentOwner: 'Cairo Central', location: 'Blood Bank', patientID: 'NONE', currentState: DINSTATE.READY});
    }
