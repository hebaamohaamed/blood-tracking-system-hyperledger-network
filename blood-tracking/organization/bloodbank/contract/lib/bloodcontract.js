...
class BloodContract extends Contract {
    ...
    */
    ...
    async instantiate(ctx) {
        ...
        blood[0] = Blood.createInstance('BD58911', '100', 'B+', '2021-06-08', '2021-09-08', 'SAFE', 'd524', '3C', '2021-06-08 00:05:03.020');
        blood[1] = Blood.createInstance('BD58912', '250', 'B+', '2021-06-08', '2021-09-08', 'SAFE', 'd524', '3C', '2021-06-08 00:05:03.020' );
        blood[2] = Blood.createInstance('BD58913', '400', 'AB+', '2021-06-08', '2021-09-08', 'SAFE', 'd526', '4C', '2021-06-08 00:05:03.020' );
        ...
        for (let i = 0; i < blood.length; i++) {
         ...
         const processBloods = new Array();
         processBloods[0] = blood[0].getKey();
         processBloods[1] = blood[1].getKey();
         process[0] = Process.createInstance('P4367', processBloods,'d524','H4657','B47745','donate','2021-06-08 00:05:03.020');
         process[1] = Process.createInstance('P4347', processBloods,'r301','H4657','B47745','recieve', '2021-06-08 00:05:03.020');
    ...
    */
   async createBloodBag(ctx, DIN, mm, type, date, expired, test, donorID, temperature, timeStamp) {
    ...
    if(donorID.startsWith("d")){
        // create blood bag
        let blood = Blood.createInstance(DIN, mm, type, date, expired, test, donorID, temperature, timeStamp);
