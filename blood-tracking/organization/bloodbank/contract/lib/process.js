...
class Process extends State {
     ...
     */
    static createInstance(processID, bloodNumber, userID, hospitalID, bloodBankID, type, date) {
        return new Process({processID, bloodNumber, userID, hospitalID, bloodBankID, type, date});
    }
