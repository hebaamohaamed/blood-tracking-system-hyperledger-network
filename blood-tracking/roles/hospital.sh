...
cd "${DIR}/organization/hospital/configuration/cli"
docker-compose -f docker-compose.yml up -d cliHospital

echo "

 Install and Instantiate a Smart Contract as 'Bloodbank'
 ...
 To add identity to the wallet:   node addToWallet.js
    < issue the paper run as Bloodbank>
...
"
echo "Suggest that you change to this dir>  cd ${DIR}/organization/hospital"